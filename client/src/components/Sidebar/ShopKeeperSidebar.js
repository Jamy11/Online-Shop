...
export default function ShopKeeperSidebar() {
  ...
  return (
    <>
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-1/5 z-10 py-4 px-6">
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                <Link
                  ...
                  to="/dashboard/add-product-catagory"
                >
                  <i
                    className={
                      "fas fa-shopping-cart mr-2 text-base " +
