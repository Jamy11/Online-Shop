...
function AddShops() {
    const validationSchema = Yup.object().shape({
        name: Yup.string().min(4).max(20).required("You must input a Name For the shop!"),
    });
    const initialValues = {
        name: '',
    }
